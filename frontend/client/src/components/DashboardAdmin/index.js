...
import AddNewHack from "./AddNewHack";
import HackathonsAdmin from "../HackathonsAdmin"; 
...
const DashboardAdmin = () => {
  ...
  if (selectedHackathon) {
    return <HackathonsAdmin hackathon={selectedHackathon} />;
  }
  ...
  return (
    <DashboardContainer>
      ...
      <HackathonButton onClick={() => setShowModal(true)}>
        Add New Hackathon
      </HackathonButton>
      <AddNewHack
        show={showModal}
      ...
      <HackathonCardContainer>
        {ongoingHackathons.map((hackathon) => (
          <HackathonCard key={hackathon.id} onClick={() => handleCardClick(hackathon)}>
